...
# The following charts show estimate Victoria-wide ATSI employment statistics and compare them with broader population values. 
# lfs_scalars <- lfs_raw %>% 
...
Full data is available for download here.\
Alternatively, you can manually explore the data in the following table.
